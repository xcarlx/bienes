...
class Servicio(models.Model):
    ...
    monto_soles = models.DecimalField(max_digits=14, decimal_places=2)
    monto_dolares = models.DecimalField(max_digits=14, decimal_places=2)
    monto_vendido = models.DecimalField(max_digits=14, decimal_places=2, blank=True, null=True)
    metros_cuadrados = models.DecimalField(max_digits=14, decimal_places=2)
