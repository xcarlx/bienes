...
from ..formstotal.comentario import ComentarioForm as Formulario


class Home(LoginRequiredMixin, TemplateView):
    template_name = "servicio/comentario/home.html"
...
class CrearObjet(LoginRequiredMixin, CreateView):
    ...
    template_name = "servicio/comentario/formulario.html"
...
class DeleteObject(LoginRequiredMixin, DeleteView):
    login_url = 'login'
    model = Object
    template_name = "servicio/comentario/delete_form.html"
    success_url = None
