...
from ..formstotal.foto import FotoForm as Formulario


class Home(LoginRequiredMixin, TemplateView):
    template_name = "servicio/fotos/home.html"
...
class CrearObjet(LoginRequiredMixin, CreateView):
    ...
    template_name = "servicio/fotos/formulario.html"
...
class DeleteObject(LoginRequiredMixin, DeleteView):
    login_url = 'login'
    model = Object
    template_name = "servicio/fotos/delete_form.html"
    success_url = None
