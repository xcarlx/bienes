...
from ..formstotal.dimension import DimensionForm as Formulario


class Home(LoginRequiredMixin, TemplateView):
    template_name = "servicio/dimensiones/home.html"
    ...
    def get(self, request, *args, **kwargs):
        if int(kwargs.get('pk')) == 0:
            ...
            objecdic = {
                ...
                "datos": {
                    "descripcion": objeto.get_tipo_display()
                }
            }
...
class CrearObjet(LoginRequiredMixin, CreateView):
    ...
    template_name = "servicio/dimensiones/formulario.html"
...
class DeleteObject(LoginRequiredMixin, DeleteView):
    login_url = 'login'
    model = Object
    template_name = "servicio/dimensiones/delete_form.html"
    success_url = None
